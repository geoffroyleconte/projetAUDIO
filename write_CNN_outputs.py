...
def write_out_sounds(mod_low,mod_high,phase_low,phase_high,pred_mod_high, 
    ...
    librosa.output.write_wav(out_dir+'/recons_CNN.wav', s_recons, 5000)
...
write_out_sounds(test_data[0],test_obj[0],test_phase_data[0],
                 test_phase_obj[0], pred_obj[0], out_dir, 100)